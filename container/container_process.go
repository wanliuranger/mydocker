...
func NewParentProcess(tty bool, containerId string, containerName string, imageName string, volume string, useLog bool, envSlices []string) (*exec.Cmd, *os.File) {
	...
	cmd.Env = append(os.Environ(), envSlices...)
